...
const FemaleProfiles: React.FC = () => {
  ...
  // Filters
  const [filters, setFilters] = useState<ProfileFilters>({ gender: 'female' });
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <View style={styles.headerContent}>
          ...
          <Text style={styles.headerTitle}>Female Profiles</Text>
      ...
      <FlatList
        ...
        ListFooterComponent={
          loadingMore ? (
            <ActivityIndicator size="large" color="#EC4899" style={{ marginVertical: 20 }} />
          ) : null
        }
        ListEmptyComponent={
          !loading ? (
            <View style={styles.emptyContainer}>
              <Ionicons name="woman" size={64} color="#E5E7EB" />
              <Text style={styles.emptyText}>No female profiles found</Text>
            </View>
          ) : null
        }
      />
